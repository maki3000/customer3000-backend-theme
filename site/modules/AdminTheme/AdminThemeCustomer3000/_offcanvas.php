...
<div id="offcanvas-nav" class="uk-offcanvas" uk-offcanvas>
	<div class="uk-offcanvas-bar">
		<p id="offcanvas-nav-header">
            ...
            <?php
                // TODO: try to set $adminTheme->url() for custom3000 theme correctly
                /*
                <img class='pw-logo' width='200' style='margin-left:-5px' src='<?php echo $adminTheme->url(); ?>uikit-pw/images/logo.png' />
                 */
            ?>
			<img class='pw-logo' width='200' style='margin-left:-5px' src='/site/modules/AdminTheme/AdminThemeCustomer3000/customer3000-pw/images/logo.png' />
		</p>
