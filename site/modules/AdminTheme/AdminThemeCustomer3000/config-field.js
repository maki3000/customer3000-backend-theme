function updateAdminThemeCustomer3000Example() {
...
function initAdminThemeCustomer3000ColumnWidth() {
	...
	var noGrid = $('body').hasClass('AdminThemeCustomer3000NoGrid');
...
$(document).ready(function() {
	$('#_adminTheme').find('input[type=radio],input[type=checkbox]').change(function() {
		updateAdminThemeCustomer3000Example();
	});
	$('#_adminTheme, #_adminTheme > *').css('background-color', '#fff');
	updateAdminThemeCustomer3000Example();
	initAdminThemeCustomer3000ColumnWidth();
