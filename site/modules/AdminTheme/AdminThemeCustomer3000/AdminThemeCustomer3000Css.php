 ...
 * 
 * @property string $configPhpHash Hash used internally to detect changes to $config->AdminThemeCustomer3000 settings.
 * @property string $configPhpName Name of property in $config that holds custom settings (default='AdminThemeCustomer3000').
 * @property int $requireCssVersion
 * @property int $cssVersion
 *
 * Settings that may be specified in $config->AdminThemeCustomer3000 array:
 * 
 ...
 * 
 */
class AdminThemeCustomer3000Css extends WireData {

	/**
	 * @var AdminTheme|AdminThemeCustomer3000
	 * 
	 */
	...
	public function getDefaults() {
		return array(
			...
			'defaultStyle' => 'reno',
			'frameworkLessFile' => __DIR__ . '/customer3000-pw/pw.less',
			'defaultCssFile' => 'customer3000-pw/pw.min.css',
			'styleDir' => 'customer3000-pw/styles/',
			'style' => '',
			'upgrade' => false,
			'recompile' => false,
			'compress' => true,
	...
	public function getCssFile($getPath = false) {
		...
		if($recompile) try {
			/** @var AdminThemeCustomer3000LessInterface $less */
	...
	/**
	 * Have the $config->AdminThemeCustomer3000 settings changed?
	 *
	 * @return bool
